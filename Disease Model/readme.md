...
- Jupyter notebook with the code for the model classificator. We use fastai and the VGG19 model architecture. Our model is feed with the preprocessed data that we obtain in our previous notebook 
